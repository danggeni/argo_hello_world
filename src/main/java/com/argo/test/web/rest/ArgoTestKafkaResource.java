...
@RestController
@RequestMapping("/api/argo-test-kafka")
public class ArgoTestKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ArgoTestKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ArgoTestKafkaResource(KafkaProperties kafkaProperties) {
