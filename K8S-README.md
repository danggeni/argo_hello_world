...
```
$ docker image tag argo_test arg_hello_world/argo_test
$ arg_hello_world arg_hello_world/argo_test
```
...
```
$ kubectl get svc argo_test -n argo_hello_world
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n argo_hello_world
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n argo_hello_world
```
